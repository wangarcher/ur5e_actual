  ...
  arm_max_acc_(arm_max_acc)
{
  ...
  robot_mode_sub_ = nh_.subscribe("/ur_hardware_interface/robot_mode",10,
                                &AdmittanceController::robot_mode_callback, this);
...
////////////////////////// Callbacks //////////////////////////
///////////////////////////////////////////////////////////////
void AdmittanceController::state_arm_callback(const ur5e_admittance_control::ADMPoseTwistConstPtr msg) {
...
void AdmittanceController::robot_mode_callback(const ur_dashboard_msgs::RobotMode::ConstPtr& msg)
{
  ur5e_mode_ = msg->mode;
  ROS_INFO("robot mode get %d",ur5e_mode_);
  ROS_INFO("robot mode w get %d", msg->mode);
}
///////////////////////////////////////////////////////////////
///////////////////// Control Loop ////////////////////////////
///////////////////////////////////////////////////////////////
...
void AdmittanceController::compute_admittance() {
  ...
  // std::cout << "this is arm_desired_twist_final: \n " <<  arm_desired_twist_final_ << "\n , and this is wrench_external: \n" << wrench_external_ << std::endl;
  // std::cout << "this is arm_desired_accelaration: \n" <<  arm_desired_accelaration << "\n , and this is error: \n" << error << std::endl;
  // std::cout << "this is arm_real_position: \n" <<  arm_real_position_ << "\n , and this is equilibrium_position: \n" << equilibrium_position_ << std::endl;
