#ifndef CARTESIAN_VELOCITY_CONTROLLER_PID_H
#define CARTESIAN_VELOCITY_CONTROLLER_PID_H
...
template<typename T>
class CartesianVelocityControllerPIDBase:
    public KinematicChainControllerBase<T>
{
public:
  CartesianVelocityControllerPIDBase() {}
  ~CartesianVelocityControllerPIDBase() {}
 ...
 * */
class CartesianVelocityControllerPID :
  public CartesianVelocityControllerPIDBase<
...
*/
class CartesianVelocityControllerPIDSim :
  public CartesianVelocityControllerPIDBase<
