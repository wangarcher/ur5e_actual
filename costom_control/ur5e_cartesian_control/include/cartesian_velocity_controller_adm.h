#ifndef CARTESIAN_VELOCITY_CONTROLLER_ADM_H
#define CARTESIAN_VELOCITY_CONTROLLER_ADM_H

#include <ros/node_handle.h>
#include <geometry_msgs/Twist.h>
#include <geometry_msgs/Pose.h>
#include <ur5e_admittance_control/ADMPoseTwist.h>
...
template<typename T>
class CartesianVelocityControllerADMBase:
    public KinematicChainControllerBase<T>
{
public:
  CartesianVelocityControllerADMBase() {}
  ~CartesianVelocityControllerADMBase() {}
...
protected:
  ...
  ur5e_admittance_control::ADMPoseTwist> > realtime_pub_;
  ...
  KDL::FrameVel x_dot_;
  KDL::Frame x_;
  ur5e_admittance_control::ADMPoseTwist msg_state_;
 ...
 * */
class CartesianVelocityControllerADM :
  public CartesianVelocityControllerADMBase<
...
*/
class CartesianVelocityControllerADMSim :
  public CartesianVelocityControllerADMBase<
