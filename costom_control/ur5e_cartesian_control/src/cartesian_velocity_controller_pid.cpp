...
PLUGINLIB_EXPORT_CLASS(controller_interface::CartesianVelocityControllerPID,
                       controller_interface::ControllerBase)
PLUGINLIB_EXPORT_CLASS(controller_interface::CartesianVelocityControllerPIDSim,
                       controller_interface::ControllerBase)
